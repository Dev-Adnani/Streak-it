...
class WeekStreakView extends StackedView<StreakUiViewModel> {
  final Habit? habit;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WavyHeatmap(
                datasets: datasets,
                colorsets: generateColorSets(
                    habit?.completionsPerInterval ?? 1, color),
                defaultColor: Colors.grey.withValues(alpha: 0.2),
              ...
              GestureDetector(
                ...
                child: CompletionWidget(
                  ...
                  total: habit?.completionsPerInterval ?? 1,
                  size: 33,
              ...
              PopupHabit(
                ...
                onArchiveTap: () async {
                  String data = await viewModel.archiveHabit(habit: habit);
                  if (data == "error") {
